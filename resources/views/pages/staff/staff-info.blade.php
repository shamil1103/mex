            ...
            <div class="col-xs-12">
                <header class="bg-info" style="border-radius: 3px;">
                    <a href="" typy="button" class="btn btn-primary" data-toggle="modal"
                        data-target="#modal-default"><i class="fa fa-plus"></i> New Staff</a>
                </header>
                    ...
                    <form role="form" action="{{ route('staff.store') }}" method="post">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="staff_name" placeholder="enter staff name"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="staff_mobile_no"
                                    placeholder="enter staff mobile no" name="staff_mobile_no" required>
                                @error('mobile_no')
                                    <span>{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="staff_nid_no" name="staff_nid_no"
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="staff_email_address"
                                    name="staff_email_address" placeholder="enter email address">
                                @error('email')
                                    <span>{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="staff_salary_amount"
                                    name="staff_salary_amount" placeholder="enter salary amount" required>
                                @error('salary')
                                    <span>{{ $message }}</span>
                                @enderror
                            </div>
