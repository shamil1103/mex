...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#"> Loan </a></li>
            <li><a href="{{ route('others-loan.index') }}"> Others Loan </a></li>
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Update Others Loan</h3>
                    </div>
                    <form action="{{ route('others-loan.update', ['others_loan' => $othersLoan->id]) }}" method="post"
                        role="form">
                        @csrf
                        @method('patch')
