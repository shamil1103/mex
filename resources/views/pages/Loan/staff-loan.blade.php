...
@section('content')
            ...
            <div class="col-xs-12">
                <header class="bg-info" style="border-radius: 3px;">
                    <a href="" typy="button" class="btn btn-primary" data-toggle="modal"
                        data-target="#modal-default"><i class="fa fa-plus"></i> New Staff Loan </a>
                </header>
                    ...
                    <form role="form" action="{{ route('staffloan.index') }}" method="post">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="expense_id" placeholder=" auto generate"
                                    name="expense_id" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control pull-right" id="" name="staff_loan_date"
                                    required>
    ...
    @enderror -->
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" style="width: 100%;" id="staff_id" name="staff_id"
                                    required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="3" placeholder="enter description" id="staff_loan_description"
                                    name="staff_loan_description"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="staff_leader_name"
                                    placeholder=" enter leader name" name="staff_leader_name" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="staff_loan_amount"
                                    placeholder="enter advance or loan amount" name="staff_loan_amount" required>
