      ...
      <div class="row">
        <div class="col-xs-12">
          <header class="bg-info" style="border-radius: 3px;">
            <a href="" typy="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-default"><i class="fa fa-plus"></i> New Bank Deposit </a>
          </header>
            ...
            <form role="form" action="{{ route('bankdeposit.store') }}" method="post">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="deposit_type" placeholder=" " name="deposit_type" value="Bank" required>
                  @error('id')  
                  <span>{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="depositor_mobile_no" placeholder="enter depositor mobile no" name="depositor_mobile_no" required>
                  @error('mobile_no')  
                  <span>{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="bank_name" placeholder="enter depositor mobile no" name="bank_name" required>
                  @error('bank_name')  
                  <span>{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" id="depositor_description" placeholder="enter address or description" name="depositor_description"></textarea>
                  @error('address')  
                  <span>{{ $message }}</span>
                  @enderror
                </div>
