      ...
      <div class="row">
        <div class="col-xs-12">
          <header class="bg-info" style="border-radius: 3px;">
            <a href="" typy="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-default"><i class="fa fa-plus"></i> Registration</a>
          </header>
            ...
            <form role="form" action="{{ route('register') }}" method="post">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="userName" placeholder="enter user name" name="name" required>
                  @error('name')  
                  <span>{{ $message }}</span>
                  @enderror
                </div>
