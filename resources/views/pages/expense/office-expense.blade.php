      ...
      <div class="row">
        <div class="col-xs-12">
          <header class="bg-info" style="border-radius: 3px;">
            <a href="" typy="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-default"><i class="fa fa-plus"></i> New Office Expense</a>
          </header>
      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form role="form" action="{{ route('officeexpense.store') }}" method="post">
              @csrf
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control pull-right" id="" name="expense_date" required>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" style="width: 100%;" id="expense_category_id" name="expense_category_id" required>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" placeholder="enter description" id="office_expense_description" name="office_expense_description"></textarea>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="office_expense_amount" placeholder="enter expense amount" name="office_expense_amount" required>
